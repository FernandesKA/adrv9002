...
int initialize(adi_adrv9001_Device_t * adrv9001Device_0, adi_adrv9001_Init_t * initialize_init_8, uint8_t * image_stream_binary, uint32_t image_stream_size)
{
	...
	error_code = adi_adrv9001_InitAnalog(adrv9001Device_0, initialize_init_8, ADI_ADRV9001_DEVICECLOCKDIVISOR_4);
	ADI_HANDLE_ERROR(error_code);

	error_code = adi_adrv9001_arm_AhbSpiBridge_Enable(adrv9001Device_0);
	ADI_HANDLE_ERROR(error_code);

	error_code = adi_adrv9001_Stream_Image_Write(adrv9001Device_0, 0, image_stream_binary, image_stream_size, ADI_ADRV9001_ARM_SINGLE_SPI_WRITE_MODE_STANDARD_BYTES_252);
	ADI_HANDLE_ERROR(error_code);
	...
	error_code = adi_adrv9001_Rx_GainTable_Write(adrv9001Device_0, ADI_ORX, ADI_CHANNEL_1, 14, initialize_gainTableRows_14, 13, &initialize_init_8->rx.rxChannelCfg[0].profile.lnaConfig, ADI_ADRV9001_RX_GAIN_CORRECTION_TABLE);
	ADI_HANDLE_ERROR(error_code);

	error_code = adi_adrv9001_Rx_GainTable_Write(adrv9001Device_0, ADI_ORX, ADI_CHANNEL_2, 14, initialize_gainTableRows_15, 13, &initialize_init_8->rx.rxChannelCfg[0].profile.lnaConfig, ADI_ADRV9001_RX_GAIN_CORRECTION_TABLE);
	ADI_HANDLE_ERROR(error_code);

	error_code = adi_adrv9001_Rx_GainTable_Write(adrv9001Device_0, ADI_RX, ADI_CHANNEL_1, 255, initialize_gainTableRows_16, 69, &initialize_init_8->rx.rxChannelCfg[0].profile.lnaConfig, ADI_ADRV9001_RX_GAIN_CORRECTION_TABLE);
	ADI_HANDLE_ERROR(error_code);

	error_code = adi_adrv9001_Rx_GainTable_Write(adrv9001Device_0, ADI_RX, ADI_CHANNEL_2, 255, initialize_gainTableRows_17, 69, &initialize_init_8->rx.rxChannelCfg[0].profile.lnaConfig, ADI_ADRV9001_RX_GAIN_CORRECTION_TABLE);
	ADI_HANDLE_ERROR(error_code);
	...
	error_code = adi_adrv9001_Tx_OutputPowerBoost_Set(adrv9001Device_0, ADI_CHANNEL_1, true);
	ADI_HANDLE_ERROR(error_code);

	error_code = adi_adrv9001_Tx_OutputPowerBoost_Set(adrv9001Device_0, ADI_CHANNEL_2, true);
	ADI_HANDLE_ERROR(error_code);
