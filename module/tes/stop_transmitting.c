...
#include "stop_transmitting.h"

int stop_transmitting(adi_adrv9001_Device_t * adrv9001Device_0)
{
	...
	error_code = adi_adrv9001_Radio_Channel_EnableRf(adrv9001Device_0, ADI_TX, ADI_CHANNEL_2, false);
	ADI_HANDLE_ERROR(error_code);
