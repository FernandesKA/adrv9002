...
#include "begin_transmitting.h"

int begin_transmitting(adi_adrv9001_Device_t * adrv9001Device_0)
{
	...
	error_code = adi_adrv9001_Radio_ChannelEnableMode_Set(adrv9001Device_0, ADI_TX, ADI_CHANNEL_2, ADI_ADRV9001_SPI_MODE);
	ADI_HANDLE_ERROR(error_code);

	error_code = adi_adrv9001_Tx_FrequencyCorrection_Set(adrv9001Device_0, ADI_CHANNEL_1, 0, true);
	error_code = adi_adrv9001_Tx_FrequencyCorrection_Set(adrv9001Device_0, ADI_CHANNEL_2, 0, true);
	error_code = adi_adrv9001_Tx_Attenuation_Set(adrv9001Device_0, ADI_CHANNEL_1, 0);
	...
	error_code = adi_adrv9001_Radio_Channel_EnableRf(adrv9001Device_0, ADI_TX, ADI_CHANNEL_2, true);
	ADI_HANDLE_ERROR(error_code);
