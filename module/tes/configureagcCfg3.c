...
adi_adrv9001_GainControlCfg_t configure_agcCfg_3 = { 
		...
		.agcMode = ADI_ADRV9001_RX_GAIN_CONTROL_DETECTION_MODE_PEAK_AND_POWER, 
		.resetOnRxon = false, 
